          ...
          <Accordion type="single" collapsible>
            ...
            >
              ...
              <AccordionContent className="bg-white text-primary-foreground px-2 py-4">
                ...
                enjoyable. Basic arithmetic skills, such as simple addition and
                subtraction, are taught with visual aids and everyday objects to
                ensure concepts are relatable.
              </AccordionContent>
            </AccordionItem>
            <AccordionItem
              className="bg-[#19AA5F] hover:bg-secondary text-secondary-foreground rounded-md  duration-500 text-sm  shadow-lg  mb-2"
            ...
            >
              ...
              <AccordionContent className="bg-white text-primary-foreground px-2 py-4">
                At Iqra Daycare, our English class is designed to instill a love
                for language and literacy from an early age. We focus on
                developing essential language skills through a variety of
                engaging activities. Storytime sessions introduce children to a
                world of imagination and vocabulary, enhancing their listening
            ...
            >
              ...
              <AccordionContent className="bg-white text-primary-foreground px-2 py-4">
                Nap time at Iqra Daycare is a crucial part of our daily routine,
                providing children with the rest they need to recharge and grow.
                In our cozy nap area, children are provided with comfortable
                bedding and a soothing environment conducive to relaxation. Soft
                music or gentle stories may accompany this time to help ease
                children into a peaceful sleep.
              </AccordionContent>
            </AccordionItem>
            <AccordionItem
              className="bg-[#19AA5F] hover:bg-secondary text-secondary-foreground rounded-md  duration-500 text-sm  shadow-lg  mb-2"
